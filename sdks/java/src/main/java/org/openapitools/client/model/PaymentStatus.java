...
public class PaymentStatus {
  ...
  public PaymentStatus id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, paymentStatus.id) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentStatus
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
