...
namespace TebexCheckout.TebexCheckout
{
    ...
    public interface IBasketsApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void UpdateBasket(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateBasketWithHttpInfo(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0);
    ...
    public interface IBasketsApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateBasketAsync(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateBasketWithHttpInfoAsync(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BasketsApi : IBasketsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void UpdateBasket(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TebexCheckout.Client.ApiResponse<Object> UpdateBasketWithHttpInfo(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0)
        {
            // verify the required parameter 'ident' is set
            if (ident == null)
            {
                throw new TebexCheckout.Client.ApiException(400, "Missing required parameter 'ident' when calling BasketsApi->UpdateBasket");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/baskets/{ident}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateBasketAsync(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await UpdateBasketWithHttpInfoAsync(ident, updateBasketRequest, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TebexCheckout.Client.ApiResponse<Object>> UpdateBasketWithHttpInfoAsync(string ident, UpdateBasketRequest? updateBasketRequest = default(UpdateBasketRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ident' is set
            if (ident == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/baskets/{ident}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
