...
namespace TebexCheckout.Model
{
    ...
    public partial class PaymentProductsInner : IValidatableObject
    {
        ...
        public PaymentProductsInner(string id = default(string), string name = default(string), int quantity = default(int), PaymentProductsInnerBasePrice basePrice = default(PaymentProductsInnerBasePrice), PaymentProductsInnerBasePrice paidPrice = default(PaymentProductsInnerBasePrice), List<string> variables = default(List<string>), DateTime? expiresAt = default(DateTime?), string custom = default(string), string username = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        public PaymentProductsInnerBasePrice PaidPrice { get; set; }
