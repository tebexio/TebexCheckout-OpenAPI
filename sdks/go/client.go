...
// APIClient manages communication with the Tebex Checkout API API v1.0.0
...
type APIClient struct {
	...
	RecurringPaymentsAPI *RecurringPaymentsAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RecurringPaymentsAPI = (*RecurringPaymentsAPIService)(&c.common)
