...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.UpdateSubscriptionRequestItemsInner();
  });
  ...
  describe('UpdateSubscriptionRequestItemsInner', function() {
    it('should create an instance of UpdateSubscriptionRequestItemsInner', function() {
      // uncomment below and update the code to test UpdateSubscriptionRequestItemsInner
      //var instance = new TebexCheckoutApi.UpdateSubscriptionRequestItemsInner();
      //expect(instance).to.be.a(TebexCheckoutApi.UpdateSubscriptionRequestItemsInner);
    });
