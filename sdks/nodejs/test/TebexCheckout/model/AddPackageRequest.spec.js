...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.AddPackageRequest();
  });
  ...
  describe('AddPackageRequest', function() {
    it('should create an instance of AddPackageRequest', function() {
      // uncomment below and update the code to test AddPackageRequest
      //var instance = new TebexCheckoutApi.AddPackageRequest();
      //expect(instance).to.be.a(TebexCheckoutApi.AddPackageRequest);
    });
