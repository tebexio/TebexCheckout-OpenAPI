...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.PaymentSubjectCustomer();
  });
  ...
  describe('PaymentSubjectCustomer', function() {
    it('should create an instance of PaymentSubjectCustomer', function() {
      // uncomment below and update the code to test PaymentSubjectCustomer
      //var instance = new TebexCheckoutApi.PaymentSubjectCustomer();
      //expect(instance).to.be.a(TebexCheckoutApi.PaymentSubjectCustomer);
    });
