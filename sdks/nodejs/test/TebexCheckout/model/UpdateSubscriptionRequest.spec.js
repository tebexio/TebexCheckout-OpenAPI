...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.UpdateSubscriptionRequest();
  });
  ...
  describe('UpdateSubscriptionRequest', function() {
    it('should create an instance of UpdateSubscriptionRequest', function() {
      ...
      //var instance = new TebexCheckoutApi.UpdateSubscriptionRequest();
      //expect(instance).to.be.a(TebexCheckoutApi.UpdateSubscriptionRequest);
    });
