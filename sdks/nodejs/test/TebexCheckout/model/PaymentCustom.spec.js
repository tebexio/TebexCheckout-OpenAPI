...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.PaymentCustom();
  });
  ...
  describe('PaymentCustom', function() {
    it('should create an instance of PaymentCustom', function() {
      // uncomment below and update the code to test PaymentCustom
      //var instance = new TebexCheckoutApi.PaymentCustom();
      //expect(instance).to.be.a(TebexCheckoutApi.PaymentCustom);
    });
