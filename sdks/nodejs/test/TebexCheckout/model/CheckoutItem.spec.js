...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.CheckoutItem();
  });
  ...
  describe('CheckoutItem', function() {
    it('should create an instance of CheckoutItem', function() {
      // uncomment below and update the code to test CheckoutItem
      //var instance = new TebexCheckoutApi.CheckoutItem();
      //expect(instance).to.be.a(TebexCheckoutApi.CheckoutItem);
    });
