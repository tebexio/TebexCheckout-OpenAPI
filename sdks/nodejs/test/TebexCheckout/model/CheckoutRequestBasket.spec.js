...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.CheckoutRequestBasket();
  });
  ...
  describe('CheckoutRequestBasket', function() {
    it('should create an instance of CheckoutRequestBasket', function() {
      // uncomment below and update the code to test CheckoutRequestBasket
      //var instance = new TebexCheckoutApi.CheckoutRequestBasket();
      //expect(instance).to.be.a(TebexCheckoutApi.CheckoutRequestBasket);
    });
