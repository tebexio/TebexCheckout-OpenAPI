...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.PaymentSubjectFees();
  });
  ...
  describe('PaymentSubjectFees', function() {
    it('should create an instance of PaymentSubjectFees', function() {
      // uncomment below and update the code to test PaymentSubjectFees
      //var instance = new TebexCheckoutApi.PaymentSubjectFees();
      //expect(instance).to.be.a(TebexCheckoutApi.PaymentSubjectFees);
    });
