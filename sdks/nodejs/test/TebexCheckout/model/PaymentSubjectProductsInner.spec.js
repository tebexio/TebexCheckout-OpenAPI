...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.PaymentSubjectProductsInner();
  });
  ...
  describe('PaymentSubjectProductsInner', function() {
    it('should create an instance of PaymentSubjectProductsInner', function() {
      // uncomment below and update the code to test PaymentSubjectProductsInner
      //var instance = new TebexCheckoutApi.PaymentSubjectProductsInner();
      //expect(instance).to.be.a(TebexCheckoutApi.PaymentSubjectProductsInner);
    });
