...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.PackageMetaData();
  });
  ...
  describe('PackageMetaData', function() {
    it('should create an instance of PackageMetaData', function() {
      // uncomment below and update the code to test PackageMetaData
      //var instance = new TebexCheckoutApi.PackageMetaData();
      //expect(instance).to.be.a(TebexCheckoutApi.PackageMetaData);
    });
