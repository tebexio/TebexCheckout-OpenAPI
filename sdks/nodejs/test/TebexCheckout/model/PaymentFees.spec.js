...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexCheckoutApi.PaymentFees();
  });
  ...
  describe('PaymentFees', function() {
    it('should create an instance of PaymentFees', function() {
      // uncomment below and update the code to test PaymentFees
      //var instance = new TebexCheckoutApi.PaymentFees();
      //expect(instance).to.be.a(TebexCheckoutApi.PaymentFees);
    });
