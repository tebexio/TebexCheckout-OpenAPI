...
class Basket {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('recurringNextPaymentDate')) {
                obj['recurringNextPaymentDate'] = ApiClient.convertToType(data['recurringNextPaymentDate'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['recurringNextPaymentDate'] && !(typeof data['recurringNextPaymentDate'] === 'string' || data['recurringNextPaymentDate'] instanceof String)) {
            throw new Error("Expected the field `recurringNextPaymentDate` to be a primitive type in the JSON string but got " + data['recurringNextPaymentDate']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} recurringNextPaymentDate
 */
Basket.prototype['recurringNextPaymentDate'] = undefined;
