 ...
 * @module TebexCheckout/model/PackageMetaData
 * @version 1.0.0
 */
class PackageMetaData {
    /**
     * Constructs a new <code>PackageMetaData</code>.
     * @alias module:TebexCheckout/model/PackageMetaData
     */
    constructor() { 
     ...
     * @param {module:TebexCheckout/model/PackageMetaData} obj Optional instance to populate.
     * @return {module:TebexCheckout/model/PackageMetaData} The populated <code>PackageMetaData</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PackageMetaData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageMetaData</code>.
     */
 ...
 */
PackageMetaData.prototype['custom'] = undefined;
