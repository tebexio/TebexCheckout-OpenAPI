...
class BasketsApi
{
     ...
     * @return void
     */
    public function updateBasket($ident, $update_basket_request = null, string $contentType = self::contentTypes['updateBasket'][0])
    {
        $this->updateBasketWithHttpInfo($ident, $update_basket_request, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBasketWithHttpInfo($ident, $update_basket_request = null, string $contentType = self::contentTypes['updateBasket'][0])
    {
        $request = $this->updateBasketRequest($ident, $update_basket_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBasketAsync($ident, $update_basket_request = null, string $contentType = self::contentTypes['updateBasket'][0])
    {
        return $this->updateBasketAsyncWithHttpInfo($ident, $update_basket_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBasketAsyncWithHttpInfo($ident, $update_basket_request = null, string $contentType = self::contentTypes['updateBasket'][0])
    {
        $returnType = '';
        $request = $this->updateBasketRequest($ident, $update_basket_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateBasketRequest($ident, $update_basket_request = null, string $contentType = self::contentTypes['updateBasket'][0])
    {

        // verify the required parameter 'ident' is set
        if ($ident === null || (is_array($ident) && count($ident) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ident when calling updateBasket'
            );
        }
