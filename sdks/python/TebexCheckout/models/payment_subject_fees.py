...
class PaymentSubjectFees(BaseModel):
    """
    PaymentSubjectFees
    """ # noqa: E501
    tax: Optional[PaymentSubjectPrice] = None
    gateway: Optional[PaymentSubjectPrice] = None
    __properties: ClassVar[List[str]] = ["tax", "gateway"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax": PaymentSubjectPrice.from_dict(obj["tax"]) if obj.get("tax") is not None else None,
            "gateway": PaymentSubjectPrice.from_dict(obj["gateway"]) if obj.get("gateway") is not None else None
        })
        return _obj
