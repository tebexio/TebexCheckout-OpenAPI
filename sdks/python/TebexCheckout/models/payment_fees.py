...
class PaymentFees(BaseModel):
    ...
    PaymentFees
    """ # noqa: E501
    tax: Optional[PaymentFeesTax] = None
    gateway: Optional[PaymentFeesGateway] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax": PaymentFeesTax.from_dict(obj["tax"]) if obj.get("tax") is not None else None,
            "gateway": PaymentFeesGateway.from_dict(obj["gateway"]) if obj.get("gateway") is not None else None
        })
        return _obj
