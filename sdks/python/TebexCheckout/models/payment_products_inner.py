...
class PaymentProductsInner(BaseModel):
    ...
    paid_price: Optional[PaymentProductsInnerBasePrice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paid_price": PaymentProductsInnerBasePrice.from_dict(obj["paid_price"]) if obj.get("paid_price") is not None else None,
