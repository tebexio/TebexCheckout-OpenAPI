...
class PaymentSubjectProductsInner(BaseModel):
    """
    ...
    base_price: Optional[PaymentSubjectPrice] = None
    paid_price: Optional[PaymentFeesTax] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "base_price": PaymentSubjectPrice.from_dict(obj["base_price"]) if obj.get("base_price") is not None else None,
            "paid_price": PaymentFeesTax.from_dict(obj["paid_price"]) if obj.get("paid_price") is not None else None,
