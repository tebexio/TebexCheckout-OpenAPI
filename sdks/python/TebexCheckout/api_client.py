...
from TebexCheckout.api_response import ApiResponse, T as ApiResponseT
import TebexCheckout.models
from TebexCheckout import rest
from TebexCheckout.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(TebexCheckout.models, klass)
