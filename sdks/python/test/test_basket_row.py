...
class TestBasketRow(unittest.TestCase):
    """BasketRow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasketRow:
        """Test BasketRow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasketRow`
        """
        model = BasketRow()
        if include_optional:
            return BasketRow(
