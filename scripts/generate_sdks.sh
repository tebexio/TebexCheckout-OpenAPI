...
openapi-generator-cli generate -i ../openapi.yaml -o ../_generated/openapi --api-package TebexCheckout --package-name TebexCheckout -g openapi --invoker-package TebexCheckout &
openapi-generator-cli generate -i ../openapi.yaml -o ../_generated/openapi-yaml --api-package TebexCheckout --package-name TebexCheckout -g openapi-yaml --invoker-package TebexCheckout &
openapi-generator-cli generate -i ../openapi.yaml -o ../_generated/postman --api-package TebexCheckout --package-name TebexCheckout -g postman-collection --invoker-package TebexCheckout &
